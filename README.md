...
| Dashboard widget | [Fleet overview](examples/dashboard-widgets/fleet-overview/) | Companion processor UI registration, extended-permission discovery, live aggregates, and fleet summaries |
